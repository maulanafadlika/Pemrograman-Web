...
class OrangTuaPolicy
{
    ...
    {
        return $user->can('view_any_orang::tua');
    }
    ...
    {
        return $user->can('view_orang::tua');
    }
    ...
    {
        return $user->can('create_orang::tua');
    }
    ...
    {
        return $user->can('update_orang::tua');
    }
    ...
    {
        return $user->can('delete_orang::tua');
    }
    ...
    {
        return $user->can('delete_any_orang::tua');
    }
